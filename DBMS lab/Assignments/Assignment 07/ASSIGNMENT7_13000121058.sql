...
CREATE TABLE JUNIORD (
	...
	TSTART DATE,
	TEND DATE,
	CONSTRAINT JFK1 FOREIGN KEY (SSN) REFERENCES DOCTOR(SSN)
);

CREATE TABLE SENIORD (
	SSN VARCHAR2(10),
	TLICENCE VARCHAR2(10),
	CONSTRAINT SFK1 FOREIGN KEY (SSN) REFERENCES DOCTOR(SSN)
);

CREATE TABLE TREAT (
	DSSN VARCHAR2(10),
	PSSN VARCHAR2(10),
	CONSTRAINT TRFK1 FOREIGN KEY (DSSN) REFERENCES DOCTOR(SSN),
	CONSTRAINT TRFK2 FOREIGN KEY (PSSN) REFERENCES PATIENT(SSN)
);

CREATE TABLE PRESCRIBE (
	DSSN VARCHAR2(10),
	MTRADENAME VARCHAR2(20),
	CONSTRAINT PRFK1 FOREIGN KEY (DSSN) REFERENCES DOCTOR(SSN),
	CONSTRAINT PRFK2 FOREIGN KEY (MTRADENAME) REFERENCES MEDICINE(TradeName)
);
...
INSERT ALL
INTO JUNIORD VALUES ('123456789', TO_DATE('2023-01-01', 'YYYY-MM-DD'), TO_DATE('2024-12-31', 'YYYY-MM-DD'))
INTO JUNIORD VALUES ('234567890', TO_DATE('2023-02-01', 'YYYY-MM-DD'), TO_DATE('2024-11-30', 'YYYY-MM-DD'))
INTO JUNIORD VALUES ('345678901', TO_DATE('2023-03-01', 'YYYY-MM-DD'), TO_DATE('2024-10-31', 'YYYY-MM-DD'))
SELECT * FROM DUAL;
--INTO JUNIORD VALUES ('456789012', TO_DATE('2023-04-01', 'YYYY-MM-DD'), TO_DATE('2024-09-30', 'YYYY-MM-DD'))
--INTO JUNIORD VALUES ('567890123', TO_DATE('2023-05-01', 'YYYY-MM-DD'), TO_DATE('2024-08-31', 'YYYY-MM-DD'))

INSERT ALL
INTO SENIORD VALUES ('456789012', 'G45678')
INTO SENIORD VALUES ('567890123', 'G56789')
SELECT * FROM dual;
-- INTO SENIORD VALUES ('123456789', 'G12345')
-- INTO SENIORD VALUES ('234567890', 'G23456')
-- INTO SENIORD VALUES ('345678901', 'G34567')

INSERT ALL
INTO TREAT VALUES ('123456789', '111111111')
INTO TREAT VALUES ('234567890', '222222222')
INTO TREAT VALUES ('345678901', '333333333')
INTO TREAT VALUES ('456789012', '444444444')
INTO TREAT VALUES ('567890123', '555555555')
SELECT * FROM DUAL;

INSERT ALL
INTO PRESCRIBE VALUES ('123456789', 'Aspirin')
INTO PRESCRIBE VALUES ('234567890', 'Paracetamol')
INTO PRESCRIBE VALUES ('345678901', 'Ibuprofen')
INTO PRESCRIBE VALUES ('456789012', 'Amoxicillin')
INTO PRESCRIBE VALUES ('567890123', 'Vitamin')
SELECT * FROM DUAL;
...
-- VII) List the first and last name of patients who have no prescriptions written by doctors other than their primary doctors.
SELECT p.FirstName, p.LastName
FROM PATIENT p
WHERE NOT EXISTS (
    SELECT *
